    ...
    if (error || !data) {
        return (
            <Box sx={{ p: 4 }}>
                ...
                <Button startIcon={<BackIcon />} onClick={() => navigate("/bills")} sx={{ mt: 2 }}>
                    Back to Bills
                </Button>
            </Box>
        );
                                ...
                                <Grid item xs={6} md={3}>
                                    ...
                                    <Box sx={{ mt: 0.5 }}>
                                        <Chip
                                            ...
                                            color={getStatusColor(bill.is_void ? "VOIDED" : bill.payment_status)}
                                            size="small"
                                            sx={{ fontWeight: 700 }}
                                        />
                                    </Box>
                            ...
                            <Box key={ret.id} sx={{ mb: idx === returns.length - 1 ? 0 : 4 }}>
                                ...
                                >
                                    <Box>
                                        ...
                                        <Typography variant="caption" color="text.secondary">
                                            {new Date(ret.created_at).toLocaleString()} by {ret.return_by_name}
                                        </Typography>
                                    </Box>
                                ...
                                <Table size="small" sx={{ mt: 1 }}>
                                    <TableBody>
                                        {ret.items.map((ri) => (
                                            <TableRow key={ri.id}>
                                                <TableCell sx={{ border: "none", py: 0.5 }}>{ri.product_name}</TableCell>
                                ...
                                <Box
                                    ...
                                    sx={{
                                        ...
                                        "&:before": {
                                            ...
                                            bottom: 0,
                                            width: "1px",
                                            bgcolor: idx === events.length - 1 ? "transparent" : "divider",
                                        },
                                        "&:after": {
                                            content: '""',
                                            position: "absolute",
